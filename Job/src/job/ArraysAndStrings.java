...
public final class ArraysAndStrings {
	...
	/*
	 * 1.2 Write code to reverse a C-style String. (i.e., including the null character)
	 */
	 ...
	 *           array is not.
	 *           
	 *     !! I say not allocating another buffer is impossible in Java due to the nature of String.
	 */
	...
	/*
	 * 1.6 Given an image represented by an NxN matrix, where each pixel
	...
	/*
	 * 1.8 Assume you have a method isSubstring which checks if one word
