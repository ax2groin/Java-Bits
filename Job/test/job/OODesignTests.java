...
import static objorient.CallCenter.*;

import objorient.CallCenter.Call;
import objorient.CallCenter.CallCenterSystem;
import objorient.Trump.BlackjackDeck;
import objorient.Trump.Card;
import objorient.Trump.Deck;
import objorient.Trump.EmptyDeckException;
import objorient.Trump.Euchre;
import objorient.Trump.EuchreDeck;
import objorient.Trump.Hearts;
import objorient.Trump.HeartsDeck;
import objorient.Trump.Rank;
import objorient.Trump.Suit;
...
public class OODesignTests {
	...
	private final class TestHandler implements CallHandler {
		...
		public boolean handle(final Call call) {
			...
			// Cheap handler for now. A more robust system would queue this off differently
