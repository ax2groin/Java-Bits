...
public final class LinkedLists {
    ...
    public static <T> List<T> listOf(T... elements) {
        ...
        return list(elements[0],
                listOf(Arrays.copyOfRange(elements, 1, elements.length)));
    }
     ...
     * 
     * !! I say the follow up cannot be done with Java's LinkedList or my
     * homebrew
     */
    @SuppressWarnings("unchecked")
    ...
    private static <T> LinkedList<T> fRemove(LinkedList<T> list,
            LinkedList<T> seed) {
    ...
    public static List<Integer> add(List<Integer>... terms) {
        ...
        while (true) {
            ...
            if (allDone(done) && rem == 0)
                return reverse(sum); // Must reverse since result is created
                                     // backwards.
            sum = list(rem % 10, sum);
            rem = rem / 10;
        }
     ...
     * 
     * !! This requires that it is possible to create such a loop, i.e., mutable
     * nodes.
     */
