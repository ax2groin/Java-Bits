...
public final class StacksAndQueues {
	...
	// Package private for other classes to use, but not meant to be used externally.
	static class Node<T> {
	 ...
	 *       
	 *     !! The way the question is written, I assume that the stack itself must be modified.
	 */
