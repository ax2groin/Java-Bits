...
import static job.LinkedLists.add;
import static job.LinkedLists.emptyList;
import static job.LinkedLists.list;
import static job.LinkedLists.listOf;
import static job.LinkedLists.nthToLast;
import static job.LinkedLists.reverse;
import static job.LinkedLists.rmDuplicates;
...
import job.LinkedLists.EmptyListException;
...
public class LinkedListsTests {
    ...
    @SuppressWarnings("unchecked") // Complaints about Integer conversion
    @Test
    public void testAddition() {
        ...
        assertEquals(differentLengths,
                add(listOf(9, 9, 9), listOf(9, 9), listOf(9)));
        assertEquals(differentLengths,
                add(listOf(9), listOf(9, 9), listOf(9, 9, 9)));
    }
    ...
    public void testCircularList() {
        MutableList<String> list = new MutableList<String>("a").append("b")
